...
struttura=STRUCT([scalini,cella,colonnato,trabeazione,altarino,tetto])

gradino=COLOR([1,0.8,0.6])(CUBOID([2,6,1]))

bordo=COLOR([1,0.8,0.6])(CUBOID([2,0.4,4]))
bordoD=T([1,2])([-20,7])(bordo)
bordoS=T([1,2])([-20,12.8])(bordo)

pair_xz = [T([1,3])([2,1]),bordoD]
bordo_dx = STRUCT(NN(11)(pair_xz))

pair_xy = [T([1,3])([2,1]),bordoS]
bordo_sx = STRUCT(NN(11)(pair_xy))

pair_x = [T([1,3])([2,1]), gradino]
scala = STRUCT(NN(11)(pair_x))
scala = T([1,2])([-20,7])(scala)

VIEW(STRUCT([bordo_sx,bordo_dx,scala,struttura]))
