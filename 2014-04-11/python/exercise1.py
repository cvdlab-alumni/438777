...
def colonna(p):
		x,y=p
		plinto_a=SKELETON(1)(CIRCUMFERENCE(0.5)(10))
		pa=T([1,2])([x,y])(plinto_a)
		pl_a=PROD([pa,Q(0.2)])
		base=STRUCT([T([1,2])([x,y])(SKELETON(1)(CIRCUMFERENCE(0.3)(10)))])
...
cella=SKELETON(1)(COLOR([0.698,0,0])(T([1,2,3])([10,10,1.4])(STRUCT([cella_x,cella_y]))))
#VIEW(cella)
...
trabeazione=SKELETON(1)(COLOR([0.722,0.451,0.2])(SOLIDIFY(T([1,2,3])([10,10,11.4])(STRUCT([trab_ax,trab_bx])))))
#VIEW(trabeazione)
...
altarino=SKELETON(1)(T([1,2,3])([12.6,9,1.4])(COLOR([1,0.141,0])(CUBOID([1,2,1.5]))))
#VIEW(STRUCT([scalini,colonnato,cella,trabeazione,altarino]))

pirulino = MK([10,10,14])
corona = SKELETON(1)(T([1,2,3])([10,10,11.6])(MAP(circle(7.6))(INTERVALS(2*PI)(20))))
tetto=COLOR([0.804,0.498,0.196])(SKELETON(1)(JOIN([pirulino,corona])))
